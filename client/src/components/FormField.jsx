...
const FormField = ({
  ...
  <div className='space-y-2'>
    ...
    <input
      ...
      id={name}
      name={name}
      className="bg-white dark:bg-dark-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-lg focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 focus:border-primary-500 dark:focus:border-primary-400 outline-none block w-full p-3.5 transition-all duration-200 placeholder:text-gray-500 dark:placeholder:text-gray-400 hover:border-gray-400 dark:hover:border-gray-500"
