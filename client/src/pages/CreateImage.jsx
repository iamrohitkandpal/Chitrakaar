    ...
    <section className="max-w-6xl mx-auto animate-fade-in">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
          Transform your imagination into stunning visuals using the power of Stable Diffusion AI.
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-2 text-xs">
                <span className={`${form.prompt.length > 800 ? 'text-orange-600 dark:text-orange-400' : 'text-gray-500 dark:text-gray-400'}`}>
                  {form.prompt.length} / 1000 characters
                </span>
                {form.prompt.length > 800 && (
                  <span className="text-orange-600 dark:text-orange-400">Consider shortening for better results</span>
                )}
              </div>
            </div>
            ...
            {form.photo && (
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800 mb-6">
                  <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">🎉 Image Generated Successfully!</h3>
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    Love your creation? Share it with the community to inspire others and showcase your artistic vision.
                  </p>
                </div>
        ...
        <div className="order-1 lg:order-2">
          <div className="sticky top-24">
            <h3 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-4">Preview</h3>
            <div className="relative bg-white dark:bg-dark-800 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 min-h-[400px] flex items-center justify-center overflow-hidden group transition-all duration-300 hover:border-primary-400 dark:hover:border-primary-500">
              {form.photo ? (
                ...
                <div className="text-center">
                  ...
                  />
                  <p className="text-gray-500 dark:text-gray-400 mb-2">Your generated image will appear here</p>
                  <p className="text-sm text-gray-400 dark:text-gray-500">Enter a prompt and click generate to create amazing art</p>
                </div>
              )}
            ...
            <div className="mt-6 p-4 bg-gray-50 dark:bg-dark-700 rounded-xl">
              <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">💡 Pro Tips</h4>
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                <li>• Be specific about colors, lighting, and mood</li>
                <li>• Include artistic styles (e.g., "oil painting", "digital art")</li>
                <li>• Mention composition details (e.g., "close-up", "wide angle")</li>
                <li>• Add quality modifiers (e.g., "highly detailed", "4K")</li>
              </ul>
            </div>
          </div>
        </div>
